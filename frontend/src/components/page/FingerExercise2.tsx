...
import FingerStep1 from '../../assets/images/finger_ex2_step1.png';
import FingerStep2 from '../../assets/images/finger_ex2_step2.png';

const FingerExercise2: React.FC = () => {
...
export default FingerExercise2;